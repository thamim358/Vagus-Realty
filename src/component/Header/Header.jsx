...
import LOGO from "../img/REALTY (1).png";
    ...
    <>
      ...
      >
        <div className=" sm:mx-auto md:mx-10 lg:mx-20 flex items-center justify-between  ">
          <div className="text-[#FF3D00] font-black font-mono text-3xl ml-4">
            {/* SUMADULA */}
          ...
          <nav>
            ...
            >
              <li>
                <Links
                  className="text-black  hover:text-[#FF3D00] font-semibold font-sans cursor-pointer"
                  activeClass="active"
                  to="/"
      ...
      <div className={`overlay-menu ${isMobileMenuOpen ? "open" : "hidden"}`}>
        <div className="flex justify-between p-5 ">
          <div className="text-[#FF3D00] font-mono font-bold text-3xl ">
            SUMUDULA
          </div>
          <button
            onClick={toggleMobileMenu}
            className="text-black hover:text-[#FF3D00]  focus:outline-none"
          >
            <svg
        ...
        <ul className="p-10">
          <li className="">
            <Link
              className="text-black  hover:text-[#FF3D00] text-xl font-bold font-sans cursor-pointer"
              activeClass="active"
              to="home"
              spy={true}
              smooth={true}
