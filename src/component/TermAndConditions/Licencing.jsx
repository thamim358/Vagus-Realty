    ...
    <>
      ...
      <div className="min-h-screen p-6">
        <div className="max-w-4xl mx-auto bg-white p-8 rounded shadow-md">
          <h1 className="text-3xl font-semibold mb-6 text-[#FF3D00]">
            Licensing
          </h1>
          ...
          <div className="mb-8">
            ...
            <p>
              At Vagus Realty, we operate under various licenses and
          ...
          <div className="mt-8">
            ...
            <p>
              ...
              <a
                href="mailto:Vagus Realtyarchitects@gmail.com"
                className="text-blue-500"
              >
                Vagus Realtyarchitects@gmail.com
              </a>
            </p>
          </div>
        </div>
