    ...
    <>
      ...
      >
        <div className="max-w-4xl mx-auto bg-white p-8 rounded shadow-md">
          <p className="text-4xl sm:text-4xl lg:text-5xl text-[#FF3D00] font-Achi font-bold text-center wow fadeInUp pt-4 ">
            Terms And Conditions
          </p>
          <div className="">

            <p className="mt-6 text-gray-500 text-base  wow fadeInUp">
              Welcome to Vagus Realty, your trusted partner in Architecture and
            ...
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
              By accessing or using the services provided by Vagus Realty, you agree
            ...
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
              Vagus Realty offers a range of architecture and interior design
              ...
              between Vagus Realty and the client.
            </p>
            ...
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
              All designs, drawings, and other materials created by Vagus Realty are
              the intellectual property of Vagus Realty. Clients are granted a
            ...
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
              Vagus Realty agrees to keep all client information confidential. We will
            ...
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
              Vagus Realty reserves the right to make changes to the services,
            ...
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
              Vagus Realty is not liable for any indirect, incidental, or
              consequential damages arising from the use of our services. The
              total liability of Vagus Realty for any claim shall not exceed the total
            ...
            <p className="mt-1 text-gray-500 text-base  wow fadeInUp">
              ...
              <a href="mailto:Vagus Realtyarchitects@gmail.com">Vagus Realtyarchitects@gmail.com</a>.
            </p>
