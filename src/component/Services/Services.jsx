  ...
  return (
    ...
    <NavBar/>
      <div className="section" id="project">
        <div className="Name  text-5xl text-[#FF3D00] mt-5 font-Achi pt-5 font-bold text-center wow fadeInUp">
          Services
        </div>
        <div className="">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-4 gap-5">
            {projectData.map((project, index) => (
              <div className="flex" key={index}>
                <div
                  className="bg-white  rounded-xl drop-shadow-2xl  ring-1 ring-[#FF3D00]"
